...
class CafeteriaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Cafetería (Provider)'), centerTitle: true),
      body: Padding(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text('Items: ${carrito.items}', style: const TextStyle(fontSize: 18)),
                  Text('Total: ${carrito.total.toStringAsFixed(2)} €', style: TextStyle(fontSize: 18)),
                ],
              ),
            ),
